...
Source0  : https://cpan.metacpan.org/authors/id/E/EX/EXODIST/Test2-Suite-0.000144.tar.gz
...
%prep
%setup -q -n Test2-Suite-0.000144
cd %{_builddir}/Test2-Suite-0.000144
...
cp %{_builddir}/Test2-Suite-0.000144/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test2-Suite/304e34105d15fd496680c341fb0993b9f24973bc
if test -f Makefile.PL; then
