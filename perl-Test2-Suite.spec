...
Source0  : https://cpan.metacpan.org/authors/id/E/EX/EXODIST/Test2-Suite-0.000141.tar.gz
...
%prep
%setup -q -n Test2-Suite-0.000141
cd %{_builddir}/Test2-Suite-0.000141
...
cp %{_builddir}/Test2-Suite-0.000141/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test2-Suite/47401bd85db249c81fa0713cae3355c651aa4e9b
if test -f Makefile.PL; then
