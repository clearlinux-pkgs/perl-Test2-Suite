...
Source0  : https://cpan.metacpan.org/authors/id/E/EX/EXODIST/Test2-Suite-0.000162.tar.gz
...
%prep
%setup -q -n Test2-Suite-0.000162
cd %{_builddir}/Test2-Suite-0.000162
pushd ..
cp -a Test2-Suite-0.000162 buildavx2
popd
